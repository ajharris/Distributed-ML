...
3. Implement dataset-agnostic constructor.
4. Build NLST ingestion.
5. Add ingestion for COPDGene and LIDC-IDRI.
6. Write dataset-level validators.
7. Produce dataset Parquet outputs.
